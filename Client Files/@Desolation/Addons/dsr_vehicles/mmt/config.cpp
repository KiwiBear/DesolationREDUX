...
class CfgVehicles
{
	...
	{
		model 	= "\dsr_vehicles\mmt\dsr_mmt.p3d";  /// simple path to model
	...
	class DSR_Bike_Green_F: MMT_base
	{
		...
		model 	= "\dsr_vehicles\mmt\dsr_mmt_green.p3d";  /// simple path to model
		scope = 2;
		scopeCurator=2;		// scope 2 means it's available in Zeus mode (0 means hidden)
		side = 3;
		faction = "CIV_F";
		...
		typicalCargo[] = {"C_man_1"};
		hiddenSelections[] = {"camo1"};
		hiddenSelectionsTextures[] = {"\dsr_vehicles\mmt\data\mmt_01a_co.paa"};
	};
	class DSR_Bike_White_F: MMT_base
	{
		displayName = "White Old Mountain Bike";
		model 	= "\dsr_vehicles\mmt\dsr_mmt_white.p3d";  /// simple path to model
		scope = 2;
		scopeCurator=2;		// scope 2 means it's available in Zeus mode (0 means hidden)
		side = 3;
		faction = "CIV_F";
		...
		typicalCargo[] = {"C_man_1"};
		hiddenSelections[] = {"camo1"};
		hiddenSelectionsTextures[] = {"\dsr_vehicles\mmt\data\mmt_01b_co.paa"};
	};
};