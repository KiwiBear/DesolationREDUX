...
class CfgMagazines
{
	...
	class dsr_item_bloodbag_empty : dsr_item_base {
		...
		model = "\dsr_items\medical\bloodbag\dsr_bloodbag_empty.p3d";
	...
	class dsr_item_bloodbag_full : dsr_item_base {
		...
		model = "\dsr_items\medical\bloodbag\dsr_bloodbag_full.p3d";
		descriptionShort = "A bloodbag filled with blood.";
		descriptionUse = "TODO";
		mass = 5;
	};
	class dsr_item_syringe : dsr_item_base {
		displayName = "Antidote Syringe";
		model = "\dsr_items\medical\syringe\dsr_syringe.p3d";
		descriptionShort = "Zombie Infection Antidote";
		descriptionUse = "TODO";
		mass = 5;
	};
	class dsr_item_antibiotics : dsr_item_base {
		displayName = "Antibiotics";
		model = "\dsr_items\medical\antibiotics\dsr_antibiotics.p3d";
		descriptionShort = "Antibiotics";
		descriptionUse = "TODO";
		mass = 5;
	};
	class dsr_item_morphine : dsr_item_base {
		displayName = "Shot of Morphine";
		model = "\dsr_items\medical\morphine\dsr_morphine.p3d";
		descriptionShort = "Morphine for major pain.";
		descriptionUse = "TODO";
		mass = 5;
	};
		//--- Food
	...
	class dsr_item_sticks: dsr_item_base
	{
		editorPreview = "\A3\EditorPreviews_F\Data\CfgVehicles\Land_Axe_F.jpg";
		scope = 2;
		scopeCurator = 2;
		displayName = "Sticks";
		model = "\dsr_items\materials\dsr_sticks.p3d";
		mass = 10;
	};
	...
	class dsr_item_campfire_burning: dsr_item_base{
		author="$STR_A3_Bohemia_Interactive";
		editorPreview="\A3\EditorPreviews_F\Data\CfgVehicles\Campfire_burning_F.jpg";
		_generalMacro="Campfire_burning_F";
		scope=2;
		scopeCurator=2;
